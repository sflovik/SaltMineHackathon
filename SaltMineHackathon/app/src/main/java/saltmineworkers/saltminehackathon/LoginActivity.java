...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private static final String[] DUMMY_CREDENTIALS = new String[]{
            "saltmineworkers@osecurity.com:salt", "salt@mine.com:workers"
    };
    ...
    /**
     * Startup method to set up the login window
     * @param savedInstanceState
     */
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        // Here, the "activity_login" xml file is set to be shown
    ...
    private boolean isEmailValid(String email) {
        //TODO: Bytte ut placeholder applikasjonslogikk
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            // TODO: autentisere mot nettverkstjeneste

            try {
                // Simulerer nettverkstjeneste
                Thread.sleep(2000);
